<?php
$edgtf_blog_type = tetsuo_edge_get_archive_blog_list_layout();
tetsuo_edge_include_blog_helper_functions( 'lists', $edgtf_blog_type );
...
<div class="<?php echo esc_attr( $edgtf_holder_params['holder'] ); ?>">
	...
	<div class="<?php echo esc_attr( $edgtf_holder_params['inner'] ); ?>">
		<?php tetsuo_edge_get_blog( $edgtf_blog_type ); ?>
	</div>
	
	<?php do_action( 'tetsuo_edge_action_before_container_close' ); ?>
</div>

<?php do_action( 'tetsuo_edge_action_blog_list_additional_tags' ); ?>
<?php get_footer(); ?>