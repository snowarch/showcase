...
if ( ! function_exists( 'tetsuo_edge_add_dripicons_icon_pack' ) ) {
	function tetsuo_edge_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new TetsuoEdgeClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'tetsuo_edge_filter_add_icon_pack_into_collection', 'tetsuo_edge_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'tetsuo_edge_add_dripicons_icon_pack_option' ) ) {
	function tetsuo_edge_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'tetsuo' );
		
		return $options;
	}
	
	add_filter( 'tetsuo_edge_filter_add_icon_pack_into_options', 'tetsuo_edge_add_dripicons_icon_pack_option' );
}

class TetsuoEdgeClassDripicons implements iTetsuoEdgeInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
