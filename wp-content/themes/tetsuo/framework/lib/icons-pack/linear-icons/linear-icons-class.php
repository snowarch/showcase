...
if ( ! function_exists( 'tetsuo_edge_add_linear_icon_pack' ) ) {
	function tetsuo_edge_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new TetsuoEdgeClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'tetsuo_edge_filter_add_icon_pack_into_collection', 'tetsuo_edge_add_linear_icon_pack' );
}

if ( ! function_exists( 'tetsuo_edge_add_linear_icon_pack_option' ) ) {
	function tetsuo_edge_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'tetsuo' );
		
		return $options;
	}
	
	add_filter( 'tetsuo_edge_filter_add_icon_pack_into_options', 'tetsuo_edge_add_linear_icon_pack_option' );
}

class TetsuoEdgeClassLinearIcons implements iTetsuoEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
