...
if ( ! function_exists( 'tetsuo_edge_add_linea_icon_pack' ) ) {
	function tetsuo_edge_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new TetsuoEdgeClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'tetsuo_edge_filter_add_icon_pack_into_collection', 'tetsuo_edge_add_linea_icon_pack' );
}

if ( ! function_exists( 'tetsuo_edge_add_linea_icon_pack_option' ) ) {
	function tetsuo_edge_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'tetsuo' );
		
		return $options;
	}
	
	add_filter( 'tetsuo_edge_filter_add_icon_pack_into_options', 'tetsuo_edge_add_linea_icon_pack_option' );
}

class TetsuoEdgeClassLineaIcons implements iTetsuoEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
