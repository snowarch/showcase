...
if ( ! function_exists( 'tetsuo_edge_add_ion_icon_pack' ) ) {
	function tetsuo_edge_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new TetsuoEdgeClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'tetsuo_edge_filter_add_icon_pack_into_collection', 'tetsuo_edge_add_ion_icon_pack' );
}

if ( ! function_exists( 'tetsuo_edge_add_ion_icon_pack_option' ) ) {
	function tetsuo_edge_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'tetsuo' );
		
		return $options;
	}
	
	add_filter( 'tetsuo_edge_filter_add_icon_pack_into_options', 'tetsuo_edge_add_ion_icon_pack_option' );
	add_filter( 'tetsuo_edge_filter_add_icon_pack_into_social_options', 'tetsuo_edge_add_ion_icon_pack_option' );
}

class TetsuoEdgeClassIonIcons implements iTetsuoEdgeInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
	...
	public function getBackToTopIcon() {
		...
		return $this->render('ion-android-arrow-dropup');
	}
