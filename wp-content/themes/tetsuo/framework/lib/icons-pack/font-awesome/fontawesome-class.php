...
if ( ! function_exists( 'tetsuo_edge_add_font_awesome_icon_pack' ) ) {
	function tetsuo_edge_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new TetsuoEdgeClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'tetsuo_edge_filter_add_icon_pack_into_collection', 'tetsuo_edge_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'tetsuo_edge_add_font_awesome_icon_pack_option' ) ) {
	function tetsuo_edge_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'tetsuo' );
		
		return $options;
	}
	
	add_filter( 'tetsuo_edge_filter_add_icon_pack_into_options', 'tetsuo_edge_add_font_awesome_icon_pack_option' );
	add_filter( 'tetsuo_edge_filter_add_icon_pack_into_social_options', 'tetsuo_edge_add_font_awesome_icon_pack_option' );
}

class TetsuoEdgeClassIconsFontAwesome implements iTetsuoEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
