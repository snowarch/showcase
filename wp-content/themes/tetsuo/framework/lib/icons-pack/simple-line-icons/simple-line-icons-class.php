...
if ( ! function_exists( 'tetsuo_edge_add_simple_line_icon_pack' ) ) {
	function tetsuo_edge_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new TetsuoEdgeClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'tetsuo_edge_filter_add_icon_pack_into_collection', 'tetsuo_edge_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'tetsuo_edge_add_simple_line_icon_pack_option' ) ) {
	function tetsuo_edge_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'tetsuo' );
		
		return $options;
	}
	
	add_filter( 'tetsuo_edge_filter_add_icon_pack_into_options', 'tetsuo_edge_add_simple_line_icon_pack_option' );
	add_filter( 'tetsuo_edge_filter_add_icon_pack_into_social_options', 'tetsuo_edge_add_simple_line_icon_pack_option' );
}

class TetsuoEdgeClassSimpleLineIcons implements iTetsuoEdgeInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'tetsuo'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'tetsuo'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'tetsuo'),
            'icon-social-facebook'    => esc_html__('Facebook', 'tetsuo'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'tetsuo'),
            'icon-social-github'      => esc_html__('Github', 'tetsuo'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'tetsuo'),
            'icon-social-instagram'   => esc_html__('Instagram', 'tetsuo'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'tetsuo'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'tetsuo'),
            'icon-social-reddit'      => esc_html__('Reddit', 'tetsuo'),
            'icon-social-skype'       => esc_html__('Skype', 'tetsuo'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'tetsuo'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'tetsuo'),
            'icon-social-spotify'     => esc_html__('Spotify', 'tetsuo'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'tetsuo'),
            'icon-social-twitter'     => esc_html__('Twitter', 'tetsuo'),
            'icon-social-youtube'     => esc_html__('Youtube', 'tetsuo')
        );
    }
