...
/*
   Class: TetsuoEdgeClassDashboardForm
   A class that initializes Edge Dashboard Container
*/

class TetsuoEdgeClassDashboardForm implements iTetsuoEdgeInterfaceLayoutNode, iTetsuoEdgeInterfaceRender {
	public $children;
	public $name;
	public $form_id;
	public $form_method;
...
/*
   Class: TetsuoEdgeClassDashboardGroup
   A class that initializes TetsuoEdgeClass Group Field
*/
class TetsuoEdgeClassDashboardGroup implements iTetsuoEdgeInterfaceLayoutNode, iTetsuoEdgeInterfaceRender {
	public $children;
	public $name;
	public $title;
	public $description;
...
/*
   Class: TetsuoEdgeClassDashboardTitle
   A class that initializes Dashboard Title
*/
class TetsuoEdgeClassDashboardTitle implements iTetsuoEdgeInterfaceRender {
	private $name;
	private $title;
	...
	public function render( $factory ) { ?>
		<h5 class="edgtf-dashboard-section-subtitle"
		    id="edgtf_<?php echo esc_attr( $this->name ); ?>"><?php echo esc_html( $this->title ); ?></h5>
		<?php
	}
}

/*
   Class: TetsuoEdgeClassDashboardField
   A class that initializes TetsuoEdgeClass Front Field
*/
class TetsuoEdgeClassDashboardField implements iTetsuoEdgeInterfaceRender {
	private $type;
	private $name;
	private $label;
	private $description;
...
abstract class TetsuoEdgeClassDashboardFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = "" );
}

class TetsuoEdgeClassDashboardFieldText extends TetsuoEdgeClassDashboardFieldType {
...
class TetsuoEdgeClassDashboardFieldTextArea extends TetsuoEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class TetsuoEdgeClassDashboardFieldImage extends TetsuoEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
			...
			<div class="edgtf-dashboard-gallery-holder">
				<ul class="edgtf-dashboard-gallery-images-holder">
					<?php if ( isset( $value_html ) ) {
                        echo tetsuo_edge_get_module_part( $value_html );
					} ?>
				</ul>
				<div class="edgtf-dashboard-gallery-uploader">
					<?php
					if ( tetsuo_membership_theme_installed() ) {
						echo tetsuo_edge_get_button_html( array(
							'text'         => esc_html__( 'Upload', 'tetsuo' ),
							'custom_class' => 'edgtf-dashboard-gallery-upload'
						) );
					} else {
						echo '<a itemprop="url" href="#" class="edgtf-btn edgtf-btn-medium edgtf-btn-solid edgtf-dashboard-gallery-upload"><span class="edgtf-btn-text">' . esc_html__( 'Upload', 'tetsuo' ) . '</span></a>';
					} ?>
					...
					<?php if ( $value !== '' && $value !== false ) { ?>
						<button class="edgtf-btn edgtf-btn-solid edgtf-dashboard-remove-image"><?php esc_html_e( 'Remove Media', 'tetsuo' ); ?></button>
					<?php } ?>
				</div>
			</div>
		</div>
...
class TetsuoEdgeClassDashboardFieldGallery extends TetsuoEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class TetsuoEdgeClassDashboardFieldSelect extends TetsuoEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class TetsuoEdgeClassDashboardFieldDate extends TetsuoEdgeClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class TetsuoEdgeClassDashboardFieldIcon extends TetsuoEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$options           = tetsuo_edge_icon_collections()->getIconCollectionsEmpty();
		$icons_collections = tetsuo_edge_icon_collections()->getIconCollectionsKeys();
				...
				<div class="edgtf-dashboard-item">
					...
					<div class="edgtf-dashboard-icon-holder">
						...
						<?php foreach ( $icons_collections as $icons_collection ) {
							$icons_param = tetsuo_edge_icon_collections()->getIconCollectionParamNameByKey( $icons_collection );
							$style       = 'display: none';
							...
							<div class="edgtf-icon-collection-holder" style="<?php echo esc_attr( $style ); ?>" data-icon-collection="<?php echo esc_attr( $icons_collection ); ?>">
								<select name="<?php echo esc_attr( $name . '[' . $icons_param . ']' ); ?>" id="<?php echo esc_attr( $name . '[' . $icons_param . ']' ); ?>">
									<?php
									$icons       = tetsuo_edge_icon_collections()->getIconCollection( $icons_collection );
...
class TetsuoEdgeClassDashboardFieldColor extends TetsuoEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class TetsuoEdgeClassDashboardFieldCheckBoxGroup extends TetsuoEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class TetsuoEdgeClassDashboardFieldAddress extends TetsuoEdgeClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
		if ( isset( $args["col_width"] ) ) {
			$col_width = $args["col_width"];
			...
			<div class="edgtf-dashboard-field-row">
				<div class="edgtf-dashboard-item col-lg-<?php echo esc_attr( $col_width ); ?>">
					<div class="edgtf-dashboard-input-holder">
						...
						<a id="reset" href="#" style="display:none;"><?php esc_html_e( 'Reset Marker', 'tetsuo' ); ?></a>
					</div>
				</div>
			</div>
		</div>
...
class TetsuoEdgeClassDashboardRepeater implements iTetsuoEdgeInterfaceRender {
	private $label;
	private $description;
	private $name;
	private $fields;
	...
	function __construct( $fields, $name, $label = '', $description = '', $button_text = '', $table_layout = false, $value = array() ) {
		...
		$this->name         = $name;
		$this->num_of_rows  = 1;
		$this->button_text  = ! empty( $button_text ) ? $button_text : esc_html__( 'Add New Item', 'tetsuo' );
			...
			<?php if ( $this->table_layout ) { ?>
				<div class="edgtf-dashboard-repeater-table-heading">
					<div class="edgtf-dashboard-repeater-fields-holder">
						<div class="edgtf-dashboard-repeater-table-cell edgtf-dashboard-repeater-sort"><?php esc_html_e( 'Order', 'tetsuo' ) ?></div>
						...
						<div class="edgtf-dashboard-repeater-table-cell edgtf-dashboard-repeater-remove"><?php esc_html_e( 'Remove', 'tetsuo' ) ?></div>
					</div>
				</div>
			<?php } ?>
...
class TetsuoEdgeClassDashboardFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new TetsuoEdgeClassDashboardFieldText();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'textarea':
				$field = new TetsuoEdgeClassDashboardFieldTextArea();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'date':
				$field = new TetsuoEdgeClassDashboardFieldDate();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'image':
				$field = new TetsuoEdgeClassDashboardFieldImage();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'gallery':
				$field = new TetsuoEdgeClassDashboardFieldGallery();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'select':
				$field = new TetsuoEdgeClassDashboardFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'icon':
				$field = new TetsuoEdgeClassDashboardFieldIcon();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'color':
				$field = new TetsuoEdgeClassDashboardFieldColor();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'checkboxgroup':
				$field = new TetsuoEdgeClassDashboardFieldCheckBoxGroup();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'address':
				$field = new TetsuoEdgeClassDashboardFieldAddress();
