<div class="edgtf-tabs-navigation-wrapper">
    <ul class="nav nav-tabs">
        <?php
        foreach (tetsuo_edge_options()->adminPages as $key => $page ) {
            $slug = "";
        ...
        <?php if (tetsuo_edge_core_plugin_installed()) { ?>
			<li <?php if($is_backup_options_page) { echo "class='active'"; } ?>><a href="<?php echo esc_url(get_admin_url().'admin.php?page='.EDGE_OPTIONS_SLUG.'_backup_options'); ?>"><i class="fa fa-database edgtf-tooltip edgtf-inline-tooltip left" data-placement="top" data-toggle="tooltip" title="<?php esc_attr_e('Backup Options','tetsuo'); ?>"></i><span><?php esc_html_e('Backup Options','tetsuo'); ?></span></a></li>
			<li <?php if($is_import_page) { echo "class='active'"; } ?>><a href="<?php echo esc_url(get_admin_url().'admin.php?page='.EDGE_OPTIONS_SLUG.'_tabimport'); ?>"><i class="fa fa-download edgtf-tooltip edgtf-inline-tooltip left" data-placement="top" data-toggle="tooltip" title="<?php esc_attr_e('Import','tetsuo'); ?>"></i><span><?php esc_html_e('Import','tetsuo'); ?></span></a></li>
        <?php } ?>
    </ul>
</div>