    ...
    <ul class="edgtf-pls-inner">
            ...
            <li class="edgtf-pls-item">
                <div class="edgtf-pls-image">
                    <a itemprop="url" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
                        <?php tetsuo_edge_get_module_template_part('templates/parts/image-simple', 'woocommerce', '', $params); ?>
                    </a>    
                </div>
        ...
        <?php endwhile; else: ?>
            <li class="edgtf-pls-messsage">
                <?php tetsuo_edge_get_module_template_part('templates/parts/no-posts', 'woocommerce', '', $params); ?>
            </li>
        <?php endif;
            wp_reset_postdata();
        ?>
