...
if ( ! function_exists( 'tetsuo_edge_get_hide_dep_for_header_main_menu_options' ) ) {
	function tetsuo_edge_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'tetsuo_edge_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'tetsuo_edge_header_main_navigation_options_map' ) ) {
	function tetsuo_edge_header_main_navigation_options_map() {
		$hide_dep_options = tetsuo_edge_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = tetsuo_edge_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'tetsuo' ),
		...
		tetsuo_edge_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'tetsuo' )
			)
		);
		...
		$drop_down_group = tetsuo_edge_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'tetsuo' )
			)
		);
		
		$drop_down_row1 = tetsuo_edge_add_admin_row(
			array(
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'tetsuo' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'tetsuo' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'tetsuo' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'tetsuo' )
				)
			)
		);
		...
		$first_level_group = tetsuo_edge_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'tetsuo' )
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'tetsuo' ),
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'tetsuo' ),
			)
		);
		
		$first_level_row4 = tetsuo_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'tetsuo' ),
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'tetsuo' ),
			)
		);
		
		$first_level_row5 = tetsuo_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = tetsuo_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = tetsuo_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'tetsuo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'tetsuo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = tetsuo_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'tetsuo' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'tetsuo' )
			)
		);
		...
		$second_level_wide_group = tetsuo_edge_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'tetsuo' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'tetsuo' )
			)
		);
		
		$second_level_wide_row1 = tetsuo_edge_add_admin_row(
			array(
		...
		$second_level_wide_row2 = tetsuo_edge_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = tetsuo_edge_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = tetsuo_edge_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_group',
				'title'       => esc_html__( '3nd Level Menu', 'tetsuo' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'tetsuo' )
			)
		);
		
		$third_level_row1 = tetsuo_edge_add_admin_row(
			array(
		...
		$third_level_row2 = tetsuo_edge_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_row3 = tetsuo_edge_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = tetsuo_edge_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'tetsuo' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'tetsuo' )
			)
		);
		
		$third_level_wide_row1 = tetsuo_edge_add_admin_row(
			array(
		...
		$third_level_wide_row2 = tetsuo_edge_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = tetsuo_edge_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'tetsuo_edge_action_header_main_navigation_options_map', 'tetsuo_edge_header_main_navigation_options_map', 10, 1 );
}