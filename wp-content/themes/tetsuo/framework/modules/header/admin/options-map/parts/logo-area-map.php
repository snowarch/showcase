...
if ( ! function_exists( 'tetsuo_edge_get_hide_dep_for_header_logo_area_options' ) ) {
	function tetsuo_edge_get_hide_dep_for_header_logo_area_options() {
		$hide_dep_options = apply_filters( 'tetsuo_edge_filter_header_logo_area_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'tetsuo_edge_header_logo_area_options_map' ) ) {
	function tetsuo_edge_header_logo_area_options_map( $panel_header ) {
		$hide_dep_options = tetsuo_edge_get_hide_dep_for_header_logo_area_options();
		...
		tetsuo_edge_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Logo Area', 'tetsuo' )
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set grid background transparency', 'tetsuo' ),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Set background color for logo area', 'tetsuo' )
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set background transparency for logo area', 'tetsuo' ),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		$logo_area_border_container = tetsuo_edge_add_admin_container(
			array(
				'parent'          => $logo_area_container,
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Border Color', 'tetsuo' ),
				'description'   => esc_html__( 'Set border color for logo area', 'tetsuo' ),
		...
		do_action( 'tetsuo_edge_header_logo_area_additional_options', $logo_area_container );
	}
	
	add_action( 'tetsuo_edge_action_header_logo_area_options_map', 'tetsuo_edge_header_logo_area_options_map', 10, 1 );
}