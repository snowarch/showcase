...
if ( ! function_exists('tetsuo_edge_contact_form_7_options_map') ) {

	function tetsuo_edge_contact_form_7_options_map() {
		
		tetsuo_edge_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'tetsuo' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = tetsuo_edge_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'tetsuo' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = tetsuo_edge_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'tetsuo' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'tetsuo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = tetsuo_edge_add_admin_row(
			array(
		...
		tetsuo_edge_add_admin_field(
			array(
				'parent'        => $typography_text_row1,
				'type'          => 'colorsimple',
				'name'          => 'cf7_style_1_text_placeholder_color',
				'default_value' => '',
				'label'         => esc_html__( 'Placeholder Text Color', 'tetsuo' ),
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'tetsuo' ),
			)
		);
		...
		$typography_text_row2 = tetsuo_edge_add_admin_row(
			array(
		...
		$typography_text_row3 = tetsuo_edge_add_admin_row(
			array(
		...
		$typography_label_group = tetsuo_edge_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'tetsuo' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'tetsuo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = tetsuo_edge_add_admin_row(
			array(
		...
		$typography_label_row2 = tetsuo_edge_add_admin_row(
			array(
		...
		$background_border_group = tetsuo_edge_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'tetsuo' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'tetsuo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = tetsuo_edge_add_admin_row(
			array(
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'tetsuo' )
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'tetsuo' )
			)
		);
		
		$background_border_row2 = tetsuo_edge_add_admin_row(
			array(
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'tetsuo' ),
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'tetsuo' )
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'tetsuo' )
			)
		);
		
		$background_border_row3 = tetsuo_edge_add_admin_row(
			array(
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'tetsuo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'tetsuo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = tetsuo_edge_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'tetsuo' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = tetsuo_edge_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'tetsuo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'tetsuo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'tetsuo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'tetsuo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = tetsuo_edge_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'tetsuo' ),
				'description' => esc_html__( 'Setup form elements margin', 'tetsuo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = tetsuo_edge_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'tetsuo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'tetsuo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'tetsuo' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'tetsuo' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = tetsuo_edge_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'tetsuo' ),
				'description' => esc_html__( 'Setup button text typography', 'tetsuo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = tetsuo_edge_add_admin_row(
			array(
		...
		$button_typography_row2 = tetsuo_edge_add_admin_row(
			array(
		...
		$button_background_border_group = tetsuo_edge_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'tetsuo' ),
				'description' => esc_html__( 'Setup button background and border style', 'tetsuo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = tetsuo_edge_add_admin_row(
			array(
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'tetsuo' )
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'tetsuo' )
			)
		);
		
		$button_background_border_row2 = tetsuo_edge_add_admin_row(
			array(
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'tetsuo' )
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'tetsuo' )
			)
		);
		
		$button_background_border_row3 = tetsuo_edge_add_admin_row(
			array(
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'tetsuo' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'tetsuo' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = tetsuo_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'tetsuo')
		));

		//Text Typography

		$typography_text_group = tetsuo_edge_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'tetsuo'),
			'description'	=> esc_html__('Setup typography for form elements text', 'tetsuo'),
		...
		$typography_text_row1 = tetsuo_edge_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = tetsuo_edge_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = tetsuo_edge_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = tetsuo_edge_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'tetsuo'),
			'description'	=> esc_html__('Setup typography for form elements label', 'tetsuo'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = tetsuo_edge_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = tetsuo_edge_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = tetsuo_edge_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'tetsuo'),
			'description'	=> esc_html__('Setup form elements background and border style', 'tetsuo'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = tetsuo_edge_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = tetsuo_edge_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = tetsuo_edge_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = tetsuo_edge_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'tetsuo'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = tetsuo_edge_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = tetsuo_edge_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'tetsuo'),
			'description'	=> esc_html__('Setup form elements margin', 'tetsuo'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = tetsuo_edge_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = tetsuo_edge_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'tetsuo'),
			'description'	=> esc_html__('Setup button text typography', 'tetsuo'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = tetsuo_edge_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = tetsuo_edge_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = tetsuo_edge_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'tetsuo'),
			'description'	=> esc_html__('Setup button background and border style', 'tetsuo'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = tetsuo_edge_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = tetsuo_edge_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = tetsuo_edge_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = tetsuo_edge_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'tetsuo')
        ));
        ...
        $typography_label_row3 = tetsuo_edge_add_admin_row(array(
        ...
        $button_typography_row3 = tetsuo_edge_add_admin_row(array(
	...
	add_action( 'tetsuo_edge_action_options_map', 'tetsuo_edge_contact_form_7_options_map', tetsuo_edge_set_options_map_position( 'contact_form_7' ) );
}