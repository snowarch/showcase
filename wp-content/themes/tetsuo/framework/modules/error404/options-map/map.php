...
if ( ! function_exists( 'tetsuo_edge_error_404_options_map' ) ) {
	function tetsuo_edge_error_404_options_map() {
		
		tetsuo_edge_add_admin_page(
			array(
				'slug'  => '__404_error_page',
				'title' => esc_html__( '404 Error Page', 'tetsuo' ),
				'icon'  => 'fa fa-exclamation-triangle'
			)
		);
		
		$panel_404_header = tetsuo_edge_add_admin_panel(
			array(
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a border bottom color for header area', 'tetsuo' )
			)
		);
		...
		$panel_404_options = tetsuo_edge_add_admin_panel(
			array(
				'page'  => '__404_error_page',
				'name'  => 'panel_404_options',
				'title' => esc_html__( '404 Page Options', 'tetsuo' )
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a background image for 404 page', 'tetsuo' )
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a pattern image for 404 page', 'tetsuo' )
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Title Image', 'tetsuo' ),
				'description' => esc_html__( 'Choose a background image for displaying above 404 page Title', 'tetsuo' )
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'name'          => '404_title',
				'default_value' => '',
				'label'         => esc_html__( 'Title', 'tetsuo' ),
				'description'   => esc_html__( 'Enter title for 404 page. Default label is "404".', 'tetsuo' )
			)
		);
		...
		$first_level_group = tetsuo_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Title Style', 'tetsuo' ),
				'description' => esc_html__( 'Define styles for 404 page title', 'tetsuo' )
			)
		);
        ...
        $first_level_group_responsive = tetsuo_edge_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'first_level_group_responsive',
                'title'       => esc_html__( 'Title Style Responsive', 'tetsuo' ),
                'description' => esc_html__( 'Define responsive styles for 404 page title (under 680px)', 'tetsuo' )
            )
        );
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'name'          => '404_subtitle',
				'default_value' => '',
				'label'         => esc_html__( 'Subtitle', 'tetsuo' ),
				'description'   => esc_html__( 'Enter subtitle for 404 page. Default label is "PAGE NOT FOUND".', 'tetsuo' )
			)
		);
		...
		$second_level_group = tetsuo_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Subtitle Style', 'tetsuo' ),
				'description' => esc_html__( 'Define styles for 404 page subtitle', 'tetsuo' )
			)
		);
        ...
        $second_level_group_responsive = tetsuo_edge_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'second_level_group_responsive',
                'title'       => esc_html__( 'Subtitle Style Responsive', 'tetsuo' ),
                'description' => esc_html__( 'Define responsive styles for 404 page subtitle (under 680px)', 'tetsuo' )
            )
        );
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'name'          => '404_text',
				'default_value' => '',
				'label'         => esc_html__( 'Text', 'tetsuo' ),
				'description'   => esc_html__( 'Enter text for 404 page.', 'tetsuo' )
			)
		);
		...
		$third_level_group = tetsuo_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Text Style', 'tetsuo' ),
				'description' => esc_html__( 'Define styles for 404 page text', 'tetsuo' )
			)
		);
        ...
        $third_level_group_responsive = tetsuo_edge_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'third_level_group_responsive',
                'title'       => esc_html__( 'Text Style Responsive', 'tetsuo' ),
                'description' => esc_html__( 'Define responsive styles for 404 page text (under 680px)', 'tetsuo' )
            )
        );
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Back to Home Button Label', 'tetsuo' ),
				'description' => esc_html__( 'Enter label for "Back to home" button', 'tetsuo' )
			)
		);
		...
		tetsuo_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Skin', 'tetsuo' ),
				'description'   => esc_html__( 'Choose a style to make Back to Home button in that predefined style', 'tetsuo' ),
				'options'       => array(
					''            => esc_html__( 'Default', 'tetsuo' ),
					'dark-style' => esc_html__( 'Dark', 'tetsuo' )
				)
			)
		);
	}
	
	add_action( 'tetsuo_edge_action_options_map', 'tetsuo_edge_error_404_options_map', tetsuo_edge_set_options_map_position( '404' ) );
}