...
if ( ! function_exists( 'tetsuo_edge_get_blog_holder_params' ) ) {
	...
	function tetsuo_edge_get_blog_holder_params( $params ) {
		...
		$masonry_layout = tetsuo_edge_get_meta_field_intersect( 'blog_masonry_layout' );
...
if ( ! function_exists( 'tetsuo_edge_get_blog_list_classes' ) ) {
	/**
	 * Function that generates blog list holder classes for blog list templates
	 */
	function tetsuo_edge_get_blog_list_classes( $classes ) {
		$list_classes   = array();
		$list_classes[] = 'edgtf-grid-list edgtf-grid-masonry-list';
		
		$number_of_columns = tetsuo_edge_get_meta_field_intersect( 'blog_masonry_number_of_columns' );
		if ( ! empty( $number_of_columns ) ) {
			$list_classes[] = 'edgtf-' . $number_of_columns . '-columns';
		}
		
		$space_between_items = tetsuo_edge_get_meta_field_intersect( 'blog_masonry_space_between_items' );
	...
	add_filter( 'tetsuo_edge_filter_blog_list_classes', 'tetsuo_edge_get_blog_list_classes' );
}
