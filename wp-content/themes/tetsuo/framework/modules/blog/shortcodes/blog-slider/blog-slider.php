<?php
namespace TetsuoCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog Slider', 'tetsuo' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'tetsuo' )            => 'slider',
							esc_html__( 'Carousel', 'tetsuo' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'tetsuo' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
	...
	public function render( $atts, $content = null ) {
		...
		tetsuo_edge_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
