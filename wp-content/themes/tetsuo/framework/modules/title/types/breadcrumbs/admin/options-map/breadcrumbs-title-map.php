...
if ( ! function_exists('tetsuo_edge_breadcrumbs_title_type_options_map') ) {
	function tetsuo_edge_breadcrumbs_title_type_options_map($panel_typography) {
		
		tetsuo_edge_add_admin_section_title(
			array(
				'name'   => 'type_section_breadcrumbs',
				'title'  => esc_html__( 'Breadcrumbs', 'tetsuo' ),
				'parent' => $panel_typography
			)
		);
	
		$group_page_breadcrumbs_styles = tetsuo_edge_add_admin_group(
			array(
				'name'        => 'group_page_breadcrumbs_styles',
				'title'       => esc_html__( 'Breadcrumbs', 'tetsuo' ),
				'description' => esc_html__( 'Define styles for page breadcrumbs', 'tetsuo' ),
				'parent'      => $panel_typography
			)
		);
	
			$row_page_breadcrumbs_styles_1 = tetsuo_edge_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_2 = tetsuo_edge_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_3 = tetsuo_edge_add_admin_row(
				array(
	...
	add_action( 'tetsuo_edge_action_additional_title_typography_options_map', 'tetsuo_edge_breadcrumbs_title_type_options_map');
}