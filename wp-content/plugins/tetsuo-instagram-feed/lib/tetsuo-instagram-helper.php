...
/**
 * Class TetsuoInstagramHelper
 */
class TetsuoInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines tetsuo_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image ) {
		...
		$imageAtts = apply_filters( 'tetsuo_instagram_image_atts',
			array(
