...
include 'tetsuo-instagram-helper.php';

/**
 * Class TetsuoInstagramApi
 */
class TetsuoInstagramApi {
	...
	const INSTAGRAM_CODE = 'tetsuo_instagram_code';
	const INSTAGRAM_USER_ID = 'tetsuo_instagram_user_id';
	const INSTAGRAM_TOKEN = 'tetsuo_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'tetsuo_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'tetsuo_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'tetsuo_facebook_code';
	const FACEBOOK_TOKEN = 'tetsuo_facebook_access_token';

	const CONNECTION_TYPE = 'tetsuo_connection_type';
	...
	public function __construct() {
		...
		$this->helper = new TetsuoInstagramHelper();
	}

	/**
	 * @return TetsuoInstagramApi
	 */
	 ...
	 *
	 * @see TetsuoInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see TetsuoInstagramApi::instagramExchangeCodeForToken()
	 */
