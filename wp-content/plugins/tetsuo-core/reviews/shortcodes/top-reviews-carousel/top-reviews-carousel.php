...
namespace TetsuoCore\CPT\Shortcodes\TopReviewsCarousel;

use TetsuoCore\Lib\ShortcodeInterface;

class TopReviewsCarousel implements ShortcodeInterface {
	private $base;
	
	public function __construct() {
		$this->base = 'tetsuo_core_top_reviews_carousel';
	...
	public function vcMap() {
		$criteria_ratings = tetsuo_core_rating_criteria_for_vc();
		
		vc_map(
			array(
				'name'                      => esc_html__( 'Top Reviews Carousel', 'tetsuo-core' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					...
					array(
						...
						'heading'     => esc_html__( 'Number of Reviews', 'tetsuo-core' ),
						'description' => esc_html__( 'Leave empty for all', 'tetsuo-core' )
					),
					array(
						'type'        => 'dropdown',
						'param_name'  => 'review_criteria',
						'heading'     => esc_html__( 'Order by Review Criteria', 'tetsuo-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return tetsuo_core_get_module_shortcode_template_part( 'reviews', 'top-reviews-carousel', 'top-reviews-carousel', '', $params );
	}
