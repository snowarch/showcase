...
namespace TetsuoCore\CPT\Shortcodes\CustomFont;
...
class CustomFont implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Custom Font', 'tetsuo-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'title',
							'heading'    => esc_html__( 'Title Text', 'tetsuo-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type_out_effect',
							'heading'     => esc_html__( 'Enable Type Out Effect', 'tetsuo-core' ),
							'description' => esc_html__( 'Adds a type out effect inside custom font content', 'tetsuo-core' ),
							'value'       => array_flip( tetsuo_edge_get_yes_no_select_array( false ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'type_out_position',
							'heading'     => esc_html__( 'Position of Type Out Effect', 'tetsuo-core' ),
							'description' => esc_html__( 'Enter the position of the word after which you would like to display type out effect (e.g. if you would like the type out effect after the 3rd word, you would enter "3")', 'tetsuo-core' ),
							'dependency'  => array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'typed_color',
							'heading'    => esc_html__( 'Typed Color', 'tetsuo-core' ),
							'dependency' => array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_1',
							'heading'    => esc_html__( 'Typed Ending Number 1', 'tetsuo-core' ),
							'dependency' => Array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_2',
							'heading'    => esc_html__( 'Typed Ending Number 2', 'tetsuo-core' ),
							'dependency' => array( 'element' => 'typed_ending_1', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_3',
							'heading'    => esc_html__( 'Typed Ending Number 3', 'tetsuo-core' ),
							'dependency' => array( 'element' => 'typed_ending_2', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_4',
							'heading'    => esc_html__( 'Typed Ending Number 4', 'tetsuo-core' ),
						...
						array(
							...
							'description' => esc_html__( 'Enter the positions of the words after which you would like to create a line break (e.g. if you would like the line break after the 3rd and 8th words, you would enter "3,8")', 'tetsuo-core' ),
						...
						array(
							...
							'value'       => array_flip( tetsuo_edge_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'font_family',
							'heading'    => esc_html__( 'Font Family', 'tetsuo-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'font_size',
							'heading'    => esc_html__( 'Font Size (px or em)', 'tetsuo-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'line_height',
							'heading'    => esc_html__( 'Line Height (px or em)', 'tetsuo-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'font_weight',
							'heading'     => esc_html__( 'Font Weight', 'tetsuo-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Font Style', 'tetsuo-core' ),
							'value'       => array_flip( tetsuo_edge_get_font_style_array( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'letter_spacing',
							'heading'    => esc_html__( 'Letter Spacing (px or em)', 'tetsuo-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'text_transform',
							'heading'     => esc_html__( 'Text Transform', 'tetsuo-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Text Decoration', 'tetsuo-core' ),
							'value'       => array_flip( tetsuo_edge_get_text_decorations( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'     => esc_html__( 'Text Align', 'tetsuo-core' ),
							'value'       => array(
								...
								esc_html__( 'Justify', 'tetsuo-core' ) => 'justify'
							),
							'save_always' => true
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'tetsuo-core' ),
							'group'      => esc_html__( 'Laptops', 'tetsuo-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'tetsuo-core' ),
							'group'      => esc_html__( 'Tablets Landscape', 'tetsuo-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'tetsuo-core' ),
							'group'      => esc_html__( 'Tablets Portrait', 'tetsuo-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'tetsuo-core' ),
							'group'      => esc_html__( 'Mobiles', 'tetsuo-core' )
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = tetsuo_core_get_shortcode_module_template_part( 'templates/custom-font', 'custom-font', '', $params );
	...
	private function getHolderStyles( $params ) {
		...
		if ( ! empty( $params['font_size'] ) ) {
			if ( tetsuo_edge_string_ends_with( $params['font_size'], 'px' ) || tetsuo_edge_string_ends_with( $params['font_size'], 'em' ) ) {
		...
		if ( ! empty( $params['line_height'] ) ) {
			if ( tetsuo_edge_string_ends_with( $params['line_height'], 'px' ) || tetsuo_edge_string_ends_with( $params['line_height'], 'em' ) ) {
		...
		if ( ! empty( $params['letter_spacing'] ) ) {
			if ( tetsuo_edge_string_ends_with( $params['letter_spacing'], 'px' ) || tetsuo_edge_string_ends_with( $params['letter_spacing'], 'em' ) ) {
	...
	private function getHolderData( $params ) {
		...
		if ( $params['font_size_1366'] !== '' ) {
			if ( tetsuo_edge_string_ends_with( $params['font_size_1366'], 'px' ) || tetsuo_edge_string_ends_with( $params['font_size_1366'], 'em' ) ) {
		...
		if ( $params['font_size_1024'] !== '' ) {
			if ( tetsuo_edge_string_ends_with( $params['font_size_1024'], 'px' ) || tetsuo_edge_string_ends_with( $params['font_size_1024'], 'em' ) ) {
		...
		if ( $params['font_size_768'] !== '' ) {
			if ( tetsuo_edge_string_ends_with( $params['font_size_768'], 'px' ) || tetsuo_edge_string_ends_with( $params['font_size_768'], 'em' ) ) {
		...
		if ( $params['font_size_680'] !== '' ) {
			if ( tetsuo_edge_string_ends_with( $params['font_size_680'], 'px' ) || tetsuo_edge_string_ends_with( $params['font_size_680'], 'em' ) ) {
		...
		if ( $params['line_height_1366'] !== '' ) {
			if ( tetsuo_edge_string_ends_with( $params['line_height_1366'], 'px' ) || tetsuo_edge_string_ends_with( $params['line_height_1366'], 'em' ) ) {
		...
		if ( $params['line_height_1024'] !== '' ) {
			if ( tetsuo_edge_string_ends_with( $params['line_height_1024'], 'px' ) || tetsuo_edge_string_ends_with( $params['line_height_1024'], 'em' ) ) {
		...
		if ( $params['line_height_768'] !== '' ) {
			if ( tetsuo_edge_string_ends_with( $params['line_height_768'], 'px' ) || tetsuo_edge_string_ends_with( $params['line_height_768'], 'em' ) ) {
		...
		if ( $params['line_height_680'] !== '' ) {
			if ( tetsuo_edge_string_ends_with( $params['line_height_680'], 'px' ) || tetsuo_edge_string_ends_with( $params['line_height_680'], 'em' ) ) {
	...
	private function getModifiedTitle( $params ) {
		...
		if ( ! empty( $title ) && ( $type_out_effect === 'yes' || ! empty( $title_break_words ) ) ) {
			...
			if ( $type_out_effect === 'yes' && ! empty( $type_out_position ) ) {
				...
				$typed_html = '<span class="edgtf-cf-typed-wrap" ' . tetsuo_edge_get_inline_style( $typed_styles ) . '><span class="edgtf-cf-typed">';
