<div class="edgtf-image-with-text-holder <?php echo esc_attr($holder_classes); ?>">
    <div class="edgtf-iwt-image">
        ...
        <?php } ?>
            <?php if(is_array($image_size) && count($image_size)) : ?>
                <?php echo tetsuo_edge_generate_thumbnail($image['image_id'], null, $image_size[0], $image_size[1]); ?>
            <?php else: ?>
    ...
    <div class="edgtf-iwt-text-holder">
        <?php if(!empty($title)) { ?>
            <<?php echo esc_attr($title_tag); ?> class="edgtf-iwt-title" <?php echo tetsuo_edge_get_inline_style($title_styles); ?>>
        ...
        <?php } ?>
		<?php if(!empty($text)) { ?>
            <p class="edgtf-iwt-text" <?php echo tetsuo_edge_get_inline_style($text_styles); ?>><?php echo esc_html($text); ?></p>
        <?php } ?>
    </div>
</div>