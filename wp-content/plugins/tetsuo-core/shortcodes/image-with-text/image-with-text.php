<?php
namespace TetsuoCore\CPT\Shortcodes\ImageWithText;
...
class ImageWithText implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image With Text', 'tetsuo-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'description' => esc_html__( 'Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "thumbnail" size', 'tetsuo-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'    => esc_html__( 'Custom Link', 'tetsuo-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Title Top Margin (px)', 'tetsuo-core' ),
							'dependency' => array( 'element' => 'title', 'not_empty' => true )
						),
						array(
							'type'       => 'textarea',
						...
						array(
							...
							'heading'    => esc_html__( 'Text Top Margin (px)', 'tetsuo-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = tetsuo_core_get_shortcode_module_template_part( 'templates/image-with-text', 'image-with-text', '', $params );
	...
	private function getTitleStyles( $params ) {
		...
		if ( $params['title_top_margin'] !== '' ) {
			$styles[] = 'margin-top: ' . tetsuo_edge_filter_px( $params['title_top_margin'] ) . 'px';
		}
	...
	private function getTextStyles( $params ) {
		...
		if ( $params['text_top_margin'] !== '' ) {
			$styles[] = 'margin-top: ' . tetsuo_edge_filter_px( $params['text_top_margin'] ) . 'px';
		}
