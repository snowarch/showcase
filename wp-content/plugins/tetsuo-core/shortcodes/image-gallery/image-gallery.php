<?php
namespace TetsuoCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface
{
    ...
    public function vcMap() {
        if (function_exists('vc_map')) {
            vc_map(
                array(
                    'name'                      => esc_html__('Image Gallery', 'tetsuo-core'),
                    'base'                      => $this->getBase(),
                    ...
                    'params'                    => array(
                        ...
                        array(
                            'type'        => 'dropdown',
                            'param_name'  => 'type',
                            'heading'     => esc_html__('Gallery Type', 'tetsuo-core'),
                            'value'       => array(
                                esc_html__('Image Grid', 'tetsuo-core') => 'grid',
                                esc_html__('Masonry', 'tetsuo-core')    => 'masonry',
                                esc_html__('Slider', 'tetsuo-core')     => 'slider',
                                esc_html__('Carousel', 'tetsuo-core')   => 'carousel'
                            ),
                            'save_always' => true,
                            'admin_label' => true
                        ),
                        array(
                            'type'        => 'attach_images',
                            'param_name'  => 'images',
                            'heading'     => esc_html__('Images', 'tetsuo-core'),
                            'description' => esc_html__('Select images from media library', 'tetsuo-core')
                        ),
                        array(
                            'type'        => 'textfield',
                            'param_name'  => 'image_size',
                            'heading'     => esc_html__('Image Size', 'tetsuo-core'),
                            'description' => esc_html__('Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "full" size', 'tetsuo-core')
                        ),
                        array(
                            'type'        => 'dropdown',
                        ...
                        array(
                            ...
                            'heading'    => esc_html__('Image Behavior', 'tetsuo-core'),
                            'value'      => array(
                                esc_html__('None', 'tetsuo-core')             => '',
                                esc_html__('Open Lightbox', 'tetsuo-core')    => 'lightbox',
                                esc_html__('Open Custom Link', 'tetsuo-core') => 'custom-link',
                                esc_html__('Zoom', 'tetsuo-core')             => 'zoom',
                                esc_html__('Grayscale', 'tetsuo-core')        => 'grayscale'
                            )
                        ),
                        array(
                            'type'        => 'textarea',
                            'param_name'  => 'custom_links',
                            'heading'     => esc_html__('Custom Links', 'tetsuo-core'),
                            'description' => esc_html__('Delimit links by comma', 'tetsuo-core'),
                        ...
                        array(
                            ...
                            'heading'     => esc_html__('Enable Slider Padding', 'tetsuo-core'),
                            'description' => esc_html__('Padding left and right on stage (can see neighbours).', 'tetsuo-core'),
                            'value'       => array_flip(tetsuo_edge_get_yes_no_select_array(false)),
                            'save_always' => true,
                        ...
                        array(
                            'type'        => 'dropdown',
                            'param_name'  => 'skin',
                            'heading'     => esc_html__('Navigation/Pagination Skin', 'tetsuo-core'),
                            'value'       => array(
    ...
    public function render($atts, $content = null) {
        ...
        $html = tetsuo_core_get_shortcode_module_template_part('templates/' . $params['type'], 'image-gallery', '', $params);
