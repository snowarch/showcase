<?php
if ( ! function_exists( 'tetsuo_edge_init_google_fonts_array' ) ) {
    function tetsuo_edge_init_google_fonts_array() {
        ...
        $tetsuo_edge_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'tetsuo_edge_init_google_fonts_array');
}