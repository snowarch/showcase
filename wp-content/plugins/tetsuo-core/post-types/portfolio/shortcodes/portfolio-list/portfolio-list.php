...
namespace TetsuoCore\CPT\Shortcodes\Portfolio;
...
class PortfolioList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio List', 'tetsuo-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Portfolio List Template', 'tetsuo-core' ),
							'value'       => array(
								esc_html__( 'Gallery', 'tetsuo-core' ) => 'gallery',
								esc_html__( 'Masonry', 'tetsuo-core' ) => 'masonry',
                                esc_html__( 'Tooltip', 'tetsuo-core' ) => 'tooltip',
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Click Behavior', 'tetsuo-core' ),
							'value'      => array(
								esc_html__( 'Open portfolio single page on click', 'tetsuo-core' )   => '',
								esc_html__( 'Open gallery in Pretty Photo on click', 'tetsuo-core' ) => 'gallery'
							)
						),
						array(
							'type'        => 'dropdown',
							...
							'description' => esc_html__( 'Default value is Three', 'tetsuo-core' ),
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Per Page', 'tetsuo-core' ),
							'description' => esc_html__( 'Set number of items for your portfolio list. Enter -1 to show all.', 'tetsuo-core' ),
							'value'       => '-1'
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'image_proportions',
							'heading'     => esc_html__( 'Image Proportions', 'tetsuo-core' ),
							'value'       => array(
								esc_html__( 'Original', 'tetsuo-core' )  => 'full',
								esc_html__( 'Square', 'tetsuo-core' )    => 'square',
								esc_html__( 'Landscape', 'tetsuo-core' ) => 'landscape',
								esc_html__( 'Portrait', 'tetsuo-core' )  => 'portrait',
								esc_html__( 'Medium', 'tetsuo-core' )    => 'medium',
								esc_html__( 'Large', 'tetsuo-core' )     => 'large'
							),
							'description' => esc_html__( 'Set image proportions for your portfolio list.', 'tetsuo-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'gallery' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_fixed_proportions',
							'heading'     => esc_html__( 'Enable Fixed Image Proportions', 'tetsuo-core' ),
							'value'       => array_flip( tetsuo_edge_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Set predefined image proportions for your masonry portfolio list. This option will apply image proportions you set in Portfolio Single page - dimensions for masonry option.', 'tetsuo-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'masonry' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_image_shadow',
							'heading'     => esc_html__( 'Enable Image Shadow', 'tetsuo-core' ),
							'value'       => array_flip( tetsuo_edge_get_yes_no_select_array( false ) ),
							'save_always' => true
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'category',
							'heading'     => esc_html__( 'One-Category Portfolio List', 'tetsuo-core' ),
							'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'tetsuo-core' )
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'selected_projects',
							'heading'     => esc_html__( 'Show Only Projects with Listed IDs', 'tetsuo-core' ),
							'settings'    => array(
								'multiple'      => true,
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'Delimit ID numbers by comma (leave empty for all)', 'tetsuo-core' )
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'tag',
							'heading'     => esc_html__( 'One-Tag Portfolio List', 'tetsuo-core' ),
							'description' => esc_html__( 'Enter one tag slug (leave empty for showing all tags)', 'tetsuo-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'orderby',
							'heading'     => esc_html__( 'Order By', 'tetsuo-core' ),
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'order',
							'heading'     => esc_html__( 'Order', 'tetsuo-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Item Style', 'tetsuo-core' ),
							'value'      => array(
								esc_html__( 'Standard - Shader', 'tetsuo-core' )                 => 'standard-shader',
								esc_html__( 'Standard - Switch Featured Images', 'tetsuo-core' ) => 'standard-switch-images',
								esc_html__( 'Gallery - Overlay', 'tetsuo-core' )                 => 'gallery-overlay',
								esc_html__( 'Gallery - Overlay Split', 'tetsuo-core' )                 => 'gallery-overlay-split',
								esc_html__( 'Gallery - Overlay Zoom', 'tetsuo-core' )                 => 'gallery-overlay-zoom',
								esc_html__( 'Gallery - Slide From Image Bottom', 'tetsuo-core' ) => 'gallery-slide-from-image-bottom',
								esc_html__( 'Gallery - Switch Featured Images', 'tetsuo-core' )  => 'gallery-switch-images'
							),
							'group'      => esc_html__( 'Content Layout', 'tetsuo-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'content_top_margin',
							'heading'    => esc_html__( 'Content Top Margin (px or %)', 'tetsuo-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Bottom Margin (px or %)', 'tetsuo-core' ),
							'dependency' => array( 'element' => 'item_style', 'value' => array( 'standard-shader', 'standard-switch-images' ) ),
							'group'      => esc_html__( 'Content Layout', 'tetsuo-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Title', 'tetsuo-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Title Text Transform', 'tetsuo-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Enable Category', 'tetsuo-core' ),
							'value'      => array_flip( tetsuo_edge_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Content Layout', 'tetsuo-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Number of Images', 'tetsuo-core' ),
							'value'      => array_flip( tetsuo_edge_get_yes_no_select_array( false, true ) ),
							'dependency' => array( 'element' => 'type', 'value' => array( 'gallery' ) ),
							'group'      => esc_html__( 'Content Layout', 'tetsuo-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Excerpt', 'tetsuo-core' ),
							'value'      => array_flip( tetsuo_edge_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Content Layout', 'tetsuo-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Excerpt Length', 'tetsuo-core' ),
							'description' => esc_html__( 'Number of characters', 'tetsuo-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Type', 'tetsuo-core' ),
							'value'      => array(
								esc_html__( 'None', 'tetsuo-core' )            => 'no-pagination',
								esc_html__( 'Standard', 'tetsuo-core' )        => 'standard',
								esc_html__( 'Load More', 'tetsuo-core' )       => 'load-more',
								esc_html__( 'Infinite Scroll', 'tetsuo-core' ) => 'infinite-scroll'
							),
							'group'      => esc_html__( 'Additional Features', 'tetsuo-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'load_more_top_margin',
							'heading'    => esc_html__( 'Load More Top Margin (px or %)', 'tetsuo-core' ),
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'filter',
							'heading'    => esc_html__( 'Enable Category Filter', 'tetsuo-core' ),
							'value'      => array_flip( tetsuo_edge_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Additional Features', 'tetsuo-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Order By', 'tetsuo-core' ),
							'value'      => array(
								esc_html__( 'Name', 'tetsuo-core' )  => 'name',
								esc_html__( 'Count', 'tetsuo-core' ) => 'count',
								esc_html__( 'Id', 'tetsuo-core' )    => 'id',
								esc_html__( 'Slug', 'tetsuo-core' )  => 'slug'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Filter Text Transform', 'tetsuo-core' ),
							'value'      => array_flip( tetsuo_edge_get_text_transform_array( true ) ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'tetsuo-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Bottom Margin (px or %)', 'tetsuo-core' ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'tetsuo-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Enable Article Animation', 'tetsuo-core' ),
							'value'       => array_flip( tetsuo_edge_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Enabling this option you will enable appears animation for your portfolio list items', 'tetsuo-core' ),
							'group'       => esc_html__( 'Additional Features', 'tetsuo-core' )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		$args   = array(
			...
			'filter_text_transform'    => 'uppercase',
		...
		$additional_params['holder_data']          = tetsuo_edge_get_holder_data_for_cpt( $params, $additional_params );
		...
		$html = tetsuo_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-list', 'portfolio-holder', $params['type'], $params, $additional_params );
	...
	public function getArticleClasses( $params ) {
		...
		if ( get_post_meta( get_the_ID(), "edgtf_portfolio_featured_image_meta", true ) !== "" && ($item_style === 'standard-switch-images' || $item_style ==='gallery-switch-images') ) {
			$classes[] = 'edgtf-pl-has-switch-image';
		} elseif ( get_post_meta( get_the_ID(), "edgtf_portfolio_featured_image_meta", true ) === "" && ($item_style === 'standard-switch-images' || $item_style ==='gallery-switch-images') ) {
	...
	public function getImageSize( $params ) {
		...
		if ( ! empty( $params['image_proportions'] ) && $params['type'] == 'gallery' ) {
			...
			switch ( $image_size ) {
				case 'landscape':
					$thumb_size = 'tetsuo_edge_image_landscape';
					break;
				case 'portrait':
					$thumb_size = 'tetsuo_edge_image_portrait';
					break;
				case 'square':
					$thumb_size = 'tetsuo_edge_image_square';
					break;
				case 'medium':
					$thumb_size = 'medium';
					break;
		...
		if ( $params['type'] == 'masonry' && $params['enable_fixed_proportions'] === 'yes' ) {
			...
			switch ( $fixed_image_size ) {
				...
				case 'large-width-height':
					$thumb_size = 'tetsuo_edge_image_huge';
					break;
				default :
					$thumb_size = 'full';
					break;
	...
	public function getStandardContentStyles( $params ) {
		...
		if ( ! empty( $margin_top ) ) {
			if ( tetsuo_edge_string_ends_with( $margin_top, '%' ) || tetsuo_edge_string_ends_with( $margin_top, 'px' ) ) {
		...
		if ( ! empty( $margin_bottom ) ) {
			if ( tetsuo_edge_string_ends_with( $margin_bottom, '%' ) || tetsuo_edge_string_ends_with( $margin_bottom, 'px' ) ) {
	...
	public function getLoadMoreStyles( $params ) {
		...
		if ( ! empty( $params['load_more_top_margin'] ) ) {
			...
			if ( tetsuo_edge_string_ends_with( $margin, '%' ) || tetsuo_edge_string_ends_with( $margin, 'px' ) ) {
				$styles[] = 'margin-top: ' . $margin;
			} else {
				$styles[] = 'margin-top: ' . tetsuo_edge_filter_px( $margin ) . 'px';
			}
		}
	...
	public function getFilterHolderStyles( $params ) {
		...
		if ( ! empty( $params['filter_bottom_margin'] ) ) {
			...
			if ( tetsuo_edge_string_ends_with( $margin, '%' ) || tetsuo_edge_string_ends_with( $margin, 'px' ) ) {
				...
				$styles[] = 'margin-bottom: ' . tetsuo_edge_filter_px( $margin ) . 'px';
			}
		}
	...
	public function getItemLink() {
		...
		return apply_filters( 'tetsuo_edge_filter_portfolio_external_link', $portfolio_link );
	}
	...
	public function getItemLinkTarget() {
		...
		return apply_filters( 'tetsuo_edge_filter_portfolio_external_link_target', $portfolio_link_target );
	}
	...
	public function portfolioCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['portfolio_category_title'] ) > 0 ) ? esc_html__( 'Category', 'tetsuo-core' ) . ': ' . $value['portfolio_category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_category ) ) {
				...
				if ( ! empty( $portfolio_category_title ) ) {
					$portfolio_category_title_display = esc_html__( 'Category', 'tetsuo-core' ) . ': ' . $portfolio_category_title;
				}
	...
	public function portfolioIdAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data          = array();
				$data['value'] = $value['id'];
				$data['label'] = esc_html__( 'Id', 'tetsuo-core' ) . ': ' . $value['id'] . ( ( strlen( $value['title'] ) > 0 ) ? ' - ' . esc_html__( 'Title', 'tetsuo-core' ) . ': ' . $value['title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( ! is_wp_error( $portfolio ) ) {
				...
				if ( ! empty( $portfolio_title ) ) {
					$portfolio_title_display = ' - ' . esc_html__( 'Title', 'tetsuo-core' ) . ': ' . $portfolio_title;
				}

				$portfolio_id_display = esc_html__( 'Id', 'tetsuo-core' ) . ': ' . $portfolio_id;
	...
	public function portfolioTagAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data          = array();
				$data['value'] = $value['slug'];
				$data['label'] = ( ( strlen( $value['portfolio_tag_title'] ) > 0 ) ? esc_html__( 'Tag', 'tetsuo-core' ) . ': ' . $value['portfolio_tag_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_tag ) ) {
				...
				if ( ! empty( $portfolio_tag_title ) ) {
					$portfolio_tag_title_display = esc_html__( 'Tag', 'tetsuo-core' ) . ': ' . $portfolio_tag_title;
				}
