...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'tetsuo-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'tetsuo-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'If you left this field empty then project ID will be of the current page', 'tetsuo-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'project_info_type',
							'heading'     => esc_html__( 'Project Info Type', 'tetsuo-core' ),
							'value'       => array(
								esc_html__( 'Title', 'tetsuo-core' )          => 'title',
								esc_html__( 'Category', 'tetsuo-core' )       => 'category',
								esc_html__( 'Tag', 'tetsuo-core' )            => 'tag',
								esc_html__( 'Author', 'tetsuo-core' )         => 'author',
								esc_html__( 'Date', 'tetsuo-core' )           => 'date',
								esc_html__( 'Featured Image', 'tetsuo-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'tetsuo-core' ),
							'value'       => array_flip( tetsuo_edge_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'tetsuo-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'tetsuo-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'tetsuo-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'tetsuo-core' ),
							'value'      => array_flip( tetsuo_edge_get_title_tag( true, array( 'p' => 'p' ) ) ),
