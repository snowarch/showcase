...
class PortfolioSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Slider', 'tetsuo-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Items', 'tetsuo-core' ),
							'admin_label' => true,
							'description' => esc_html__( 'Set number of items for your portfolio slider. Enter -1 to show all', 'tetsuo-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Number of portfolios that are showing at the same time in slider (on smaller screens is responsive so there will be less items shown). Default value is Four', 'tetsuo-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Set image proportions for your portfolio slider.', 'tetsuo-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'autocomplete',
						...
						array(
							...
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'tetsuo-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Navigation Skin', 'tetsuo-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Skin', 'tetsuo-core' ),
							'value'      => array(
								esc_html__( 'Default', 'tetsuo-core' ) => '',
								esc_html__( 'Light', 'tetsuo-core' )   => 'light',
								esc_html__( 'Dark', 'tetsuo-core' )    => 'dark'
						...
						array(
							...
							'heading'     => esc_html__( 'Pagination Position', 'tetsuo-core' ),
							'value'       => array(
								esc_html__( 'Below Slider', 'tetsuo-core' ) => 'below-slider',
								esc_html__( 'On Slider', 'tetsuo-core' )    => 'on-slider'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'enable_pagination', 'value' => array( 'yes' ) ),
							'group'       => esc_html__( 'Slider Settings', 'tetsuo-core' )
